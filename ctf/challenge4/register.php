...
if(isset($_POST['username']) && isset($_POST['password']) && isset($_POST['email'])){
	...
	$query_check_user = mysqli_query($link, $sql_check_user) or die(mysqli_error($link));
	if(mysqli_num_rows($query_check_user) > 0)
		...
		$query_insert_user = mysqli_query($link, $sql_insert_user) or die(mysqli_error($link));
